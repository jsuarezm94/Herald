...
protocol DeletedRecipientDelegate {
...
class RecipientListTableViewController: UITableViewController {
    ...
    var deletedRecipientDelegate: DeletedRecipientDelegate?
    ...
    */
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == .Delete {
            ...
            recipients.removeAtIndex(indexPath.row) // delete entry from recipients array
            tableView.deleteRowsAtIndexPaths([indexPath], withRowAnimation: .Fade) // Delete the row from the data source
            tableView.endUpdates()
            deletedRecipientDelegate!.indexPathForDeletedRecipient(self, didDeleteRecipient: indexPath.row)
        }
